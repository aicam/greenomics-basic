<template>
  <v-container fluid class="text-center">
    ...
    >
      ...
      <v-row style="padding: 25px" justify="space-around">
        <v-col lg="5">
          <v-toolbar
            color="light-blue"
            dark
          ...
          >
            ...
            >
              <v-list-item-content class="text-left">
                <v-list-item-title style="color: #cecaca; font-size: 20px" v-text="item.title"></v-list-item-title>
              </v-list-item-content>
...
import FooterCustom from "@/components/Marketplace/FooterCustom";


export default {
  name: "marketplace",
  components: {FooterCustom, NFTMarketplace},
  data() {
    return ({
      gctTimeBased: [
        {
